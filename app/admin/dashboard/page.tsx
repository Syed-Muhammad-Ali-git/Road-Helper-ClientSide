      ...
      >
        ...
        <Group justify="space-between" mb={40} align="flex-end">
          <Box>
            ...
            <Title order={1} className="font-manrope font-extrabold text-4xl md:text-5xl text-white tracking-tight">
              Platform <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-gray-500">Overview</span>
            </Title>
            <Text className="text-gray-400 mt-2 font-medium">Real-time data visualization and operational controls.</Text>
          </Box>
          <motion.div variants={itemVariants}>
            <Button
              ...
              leftSection={<IconDownload size={20} className="group-hover:translate-y-1 transition-transform" />}
              ...
              <Box className="h-[350px] mb-10 relative z-10 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={revenueData}>
                    ...
                    />
                    <Area type="monotone" dataKey="total" stroke="#ef4444" strokeWidth={4} fillOpacity={1} fill="url(#total)" name="Gross Value" />
                    <Area type="monotone" dataKey="platform" stroke="#10b981" strokeWidth={4} fillOpacity={1} fill="url(#platform)" name="20% Share" />
                  </AreaChart>
                </ResponsiveContainer>
              </Box>
